  ...
  try {
    ...
    const updatedJobs = await sql`
      ...
      SET
        ...
        assigned_to_user_id = ${body.assignedToUserId !== undefined ? (body.assignedToUserId || null) : job.assigned_to_user_id},
        trade_type_id = ${body.tradeTypeId !== undefined ? (body.tradeTypeId || null) : job.trade_type_id},
        ...
        quoted_amount = ${body.quotedAmount !== undefined ? (body.quotedAmount || null) : job.quoted_amount},
        actual_amount = ${body.actualAmount !== undefined ? (body.actualAmount || null) : job.actual_amount},
