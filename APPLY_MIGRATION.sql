...
-- Or via psql: psql YOUR_DATABASE_URL < APPLY_MIGRATION.sql
...
-- Create client_reminder_preferences table
...
-- Success message
SELECT 'Migration completed successfully! Three tables created: reminder_settings, reminder_history, client_reminder_preferences' AS result;
